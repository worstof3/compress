...
def compress_one_byte(freqs):
    ...
    Compressed file is in the following format:
    ZeroByte_ByteInFile_RepeatNumber.
    RepeatNumber is a binary representation of a number of times ByteInFile is in file.

    Args:
    freqs -- Frequencies of bytes (actually one byte).
    """
    pieces = [b'\x00']
...
def compress(infile, outfile):
    ...
    outfile -- File object to save compressed file.
    """
